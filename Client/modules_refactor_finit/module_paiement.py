...
class ModulePaiement(Module):
    ...
    def set_vue(self):
        return ModulePaiement.VuePaiement(self, row=3, column=3, padx=10, pady=10)
    ...
    class VuePaiement(Vue):
        ...
        def remplir_grid_module(self):
            ...
            table = Table(vue=self, lines_array=self.liste_module, start_row=2, start_column=0, padx=50,
