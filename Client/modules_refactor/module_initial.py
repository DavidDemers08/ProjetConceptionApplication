...
class ModuleInitial(Module):
    ...
    def set_vue(self):
        return ModuleInitial.VueInitial(self, row=0, column=0, padx=10, pady=10)
    ...
    class VueInitial(Vue):
        ...
        def remplir_vue(self):
            ...
            self.bouton_enregister = ttk.Button(self, text='Enregistrer une nouvelle compagnie',
        ...
        def afficher_enregistrer(self):
            ...
            self.bouton_enregister_ville = ttk.Button(self, text='Enregistrer',
        ...
        def afficher_enregistrement_admin(self):
            ...
            self.bouton_enregister_admin = ttk.Button(self, text='Enregistrer Admin',
