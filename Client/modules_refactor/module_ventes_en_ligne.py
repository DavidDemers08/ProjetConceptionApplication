...
class Module_Ventes_En_ligne(Module):
    ...
    def set_vue(self):
        return Module_Ventes_En_ligne.VueOnlineSales(self, row=6, column=5, padx=10, pady=10)
    ...
    class VueOnlineSales(Vue):
        ...
        def remplir_vue(self):
            ...
            VueGen.generate_button(self, 'launch_verify_order', 'Verifier une commande', [25, None], [3, 1], [3, None],
                                   None)
            VueGen.generate_button(self, 'complete_order', 'Completer une commande', [25, None], [5, 1], [3, None],
                                   None)
        ...
        def remplir_vue_verifier_commande(self):
            ...
            VueGen.generate_label(self, 'order_number', "Numero de Commande", 25, 2, "groove", tk.CENTER, [2, 1],
                                  [None, None])
        ...
        def remplir_vue_finaliser_commande(self):
            ...
            VueGen.generate_label(self, 'order_number', "Numero de Commande", 25, 2, "groove", tk.CENTER, [1, 0],
                                  [None, None])
            ...
            VueGen.generate_label(self, 'order_info', "Valider Information", 25, 2, "groove", tk.CENTER, [3, 0],
                                  [None, None])
            ...
            VueGen.generate_label(self, 'order_verification', "Elements corrects", 25, 2, "groove", tk.CENTER, [5, 0],
                                  [None, None])
