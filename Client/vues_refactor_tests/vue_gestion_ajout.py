...
class VueGestionAjout(ttk.Frame):
    def __init__(self, parent):
        super().__init__(parent)
        #self.controleur = None
        self.remplir_vue_gestion_ajout()
    ...
    def open_popup(self):
         ...
         label = ttk.Label(popup, text='Sauvegarde effectue avec succes', background='black',foreground='white',justify=tk.CENTER)
         label.pack()
